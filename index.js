 ...
 *
 * @module window.Framework7/prototype/plugins/welcomescreen
 * @author www.timo-ernst.net
 * @license MIT
 */
window.Framework7.prototype.plugins.welcomescreen = function (app, globalPluginParams) {
  'use strict'
  // letiables in module scope
  let $$ = window.Dom7
  let t7 = window.Template7
  let Welcomescreen

  // Click handler to close welcomescreen
  $$(document).on('click', '.close-welcomescreen', function (e) {
    e.preventDefault()
    let $wscreen = $$(this).parents('.welcomescreen-container')
   ...
   *
   * @class
   * @memberof module:window.Framework7/prototype/plugins/welcomescreen
   */
  Welcomescreen = function (slides, options) {
     ...
     */
    function initSwiper () {
      swiper = new window.Swiper('.welcomescreen-swiper', {
